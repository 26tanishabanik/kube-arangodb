...
func Test_AT_ModV1_Metrics(t *testing.T) {
	i := newInspector()

	client := func(i inspectorInterface.Inspector) v1.ModInterface {
		return i.ArangoTaskModInterface().V1()
	}

	kind := constants.ArangoTaskKind

	object := func(name string, args ...interface{}) *api.ArangoTask {
