...
func Test_AM_ModV1_Metrics(t *testing.T) {
	i := newInspector()

	client := func(i inspectorInterface.Inspector) v1.ModInterface {
		return i.ArangoMemberModInterface().V1()
	}

	kind := constants.ArangoMemberKind

	object := func(name string, args ...interface{}) *api.ArangoMember {
